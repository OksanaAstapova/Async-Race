...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"remove_car\": () => (/* binding */ remove_car)\n/* harmony export */ });\n/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./main */ \"./src/ts/main.ts\");\n/* harmony import */ var _create_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./create-default */ \"./src/ts/create-default.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\r\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\r\n    return new (P || (P = Promise))(function (resolve, reject) {\r\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\r\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\r\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\r\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\r\n    });\r\n};\r\nvar __generator = (undefined && undefined.__generator) || function (thisArg, body) {\r\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;\r\n    return g = { next: verb(0), \"throw\": verb(1), \"return\": verb(2) }, typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\r\n    function verb(n) { return function (v) { return step([n, v]); }; }\r\n    function step(op) {\r\n        if (f) throw new TypeError(\"Generator is already executing.\");\r\n        while (_) try {\r\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\r\n            if (y = 0, t) op = [op[0] & 2, t.value];\r\n            switch (op[0]) {\r\n                case 0: case 1: t = op; break;\r\n                case 4: _.label++; return { value: op[1], done: false };\r\n                case 5: _.label++; y = op[1]; op = [0]; continue;\r\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\r\n                default:\r\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\r\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\r\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\r\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\r\n                    if (t[2]) _.ops.pop();\r\n                    _.trys.pop(); continue;\r\n            }\r\n            op = body.call(thisArg, _);\r\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\r\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\r\n    }\r\n};\r\n\r\n\r\nfunction remove_car() {\r\n    var remove_buttons = document.querySelectorAll('.remove');\r\n    remove_buttons.forEach(function (button) {\r\n        button.addEventListener('click', function () {\r\n            var car = button.parentElement.parentElement;\r\n            car.remove();\r\n            (0,_create_default__WEBPACK_IMPORTED_MODULE_1__.count_garage)();\r\n            delete_car_api(car.id);\r\n            delete_winners_api(car.id);\r\n            var page = document.querySelector(\".garage__main_pagination > h2\");\r\n            var next_btn = document.querySelector('.next-page');\r\n            var prev_btn = document.querySelector('.prev-page');\r\n            var cars_per_page = +(page.innerHTML) * 7;\r\n            console.log(cars_per_page);\r\n            var cars = document.querySelectorAll('.car-wrapper').length;\r\n            console.log(cars);\r\n            if (cars <= cars_per_page) {\r\n                next_btn.disabled = true;\r\n            }\r\n            else\r\n                next_btn.disabled = false;\r\n            prev_btn.addEventListener('click', function () {\r\n                var prev_page = +(page.innerHTML);\r\n                console.log(page.innerHTML);\r\n                page.innerHTML = \"\".concat(prev_page);\r\n            });\r\n        });\r\n    });\r\n}\r\nvar delete_car_api = function (id) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {\r\n    switch (_a.label) {\r\n        case 0: return [4 /*yield*/, fetch(\"\".concat(_main__WEBPACK_IMPORTED_MODULE_0__.garage, \"/\").concat(id), { method: 'DELETE' })];\r\n        case 1: return [2 /*return*/, (_a.sent()).json()];\r\n    }\r\n}); }); };\r\nvar delete_winners_api = function (id) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {\r\n    switch (_a.label) {\r\n        case 0: return [4 /*yield*/, fetch(\"\".concat(_main__WEBPACK_IMPORTED_MODULE_0__.winners, \"/\").concat(id), { method: 'DELETE' })];\r\n        case 1: return [2 /*return*/, (_a.sent()).json()];\r\n    }\r\n}); }); };\r\n\n\n//# sourceURL=webpack://async-race/./src/ts/remove-car.ts?");
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("efe914e571244826f3f6")
/******/ 	})();
/******/ 	
